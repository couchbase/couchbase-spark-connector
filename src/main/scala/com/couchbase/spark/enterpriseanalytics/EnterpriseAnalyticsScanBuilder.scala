...
class EnterpriseAnalyticsScanBuilder(schema: StructType, readConfig: EnterpriseAnalyticsReadConfig)
    extends ScanBuilder
  ...
  override def build(): Scan = {
    new EnterpriseAnalyticsScan(finalSchema, readConfig, pushedFilter, aggregations, limit)
  }
  ...
  override def isPartiallyPushed = false
}
