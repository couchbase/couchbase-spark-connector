...
[source,scala]
----
include::example$WorkingWithRdds.scala[tag=imports,indent=0]
----
...
[source,scala]
----
include::example$WorkingWithRdds.scala[tag=create-rdd,indent=0]
----
...
[source,scala]
----
include::example$WorkingWithRdds.scala[tag=view,indent=0]
----
...
[source,scala]
----
include::example$WorkingWithRdds.scala[tag=view-get,indent=0]
----
...
You can utilize N1QL to perform efficient queries against your JSON data in a Couchbase Bucket.
...
[source,scala]
----
include::example$WorkingWithRdds.scala[tag=query-get,indent=0]
----
...
[source,scala]
----
include::example$Examples.scala[tag=analytics,indent=0]
----
...
[source,scala]
----
include::example$WorkingWithRdds.scala[tag=query3,indent=0]
----
...
=== Parallelism
`saveToCouchbase()` will, on each active executor, write the documents to Couchbase in batches.
The default batch size is 128 - that is, 128 documents will be inserted concurrently, per executor - and this can be configured using the `maxConcurrent` parameter.
...
[source,scala]
----
include::example$WorkingWithRdds.scala[tag=batching,indent=0]
----
...
[source,scala]
----
include::example$WorkingWithRdds.scala[tag=subdoc,indent=0]
----
