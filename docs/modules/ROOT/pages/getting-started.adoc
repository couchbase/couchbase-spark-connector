...
// :page-aliases: 6.6@server:connectors:spark-1.0/spark-shell
...
Here is a reference to the http://docs.couchbase.com/sdk-api/couchbase-spark-connector-3.0.0/[Scala docs^].
