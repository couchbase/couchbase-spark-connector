...
If your environment does not have access to the internet you can use the --jars argument instead and grab the assembly with all the dependencies from here: link:download-links.html[Download and API Reference].
