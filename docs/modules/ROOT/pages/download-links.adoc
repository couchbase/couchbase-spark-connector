...
The connector is currently compiled against Scala 2.12 to comply with Spark 3.0.
...
It can also be downloaded manually here: http://packages.couchbase.com/clients/connectors/spark/3.0.0/Couchbase-Spark-Connector_2.12-3.0.0.zip[Download (Scala 2.12 / Java)^] | http://docs.couchbase.com/sdk-api/couchbase-spark-connector-3.0.0/[API Reference^]
