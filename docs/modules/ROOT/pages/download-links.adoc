...
* 2.3.0 (either of those JAR files can be used in Java applications): http://packages.couchbase.com/clients/connectors/spark/2.3.0/Couchbase-Spark-Connector_2.10-2.3.0.zip[Download (Scala 2.10 / Java)^] | http://packages.couchbase.com/clients/connectors/spark/2.3.0/Couchbase-Spark-Connector_2.11-2.3.0.zip[Download (Scala 2.11 / Java)^] | http://docs.couchbase.com/sdk-api/couchbase-spark-connector-2.3.0/[API Reference^]
