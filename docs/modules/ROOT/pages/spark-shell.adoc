...
[source,scala]
----
Downloads/spark-3.1.2-bin-hadoop2.7/bin
❯ ./spark-shell -h
...
[source]
----
./spark-shell --packages com.couchbase.client:spark-connector_2.12:3.1.0
----
...
[source]
----
./spark-shell --packages com.couchbase.client:spark-connector_2.12:3.1.0 -c spark.couchbase.connectionString=127.0.0.1 -c spark.couchbase.username=user -c spark.couchbase.password=pass
----
